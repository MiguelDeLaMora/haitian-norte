...
export const metadata: Metadata = {
  ...
  description:
    "Tornos CNC respaldados por la tecnología global del Grupo Haitian. 24 MSI, 15% de enganche e instalación incluida.",
  alternates: { canonical: "/tornos-cnc" },
  openGraph: {
    title: "Tornos CNC con Financiamiento Directo | Haitian Norte",
    description:
      "Tornos CNC respaldados por la tecnología global del Grupo Haitian.",
    url: "/tornos-cnc",
  },
};
