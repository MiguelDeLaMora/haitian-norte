...
export const metadata: Metadata = {
  ...
  description:
    "Centros de maquinado CNC fabricados en México, respaldados por la tecnología global del Grupo Haitian. 24 MSI, 15% de enganche e instalación incluida.",
  alternates: { canonical: "/maquinas-cnc" },
  openGraph: {
    title: "Máquinas CNC con Financiamiento Directo | Haitian Norte",
    description:
      "Centros de maquinado CNC fabricados en México, respaldados por la tecnología global del Grupo Haitian.",
    url: "/maquinas-cnc",
  },
};
